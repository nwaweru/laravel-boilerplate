<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        @canany(['users.index', 'roles.index', 'permission_groups', 'permissions.index', 'auditing.index'])
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#settings-nav" aria-expanded="false" aria-controls="settings-nav">
                ...
                <div class="collapse" id="settings-nav">
                    <ul class="nav flex-column sub-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.permissionGroups.index') }}">Permission Groups</a>
                        </li>
                        @endcan
